...
mydata %>%
     slice(1:6) %>% 
       knitr::kable(col.names = c("Country",
                      ...
                      "Population",
                      "GPD per Capita",
                      "Population (millions")) # To get better formatting of the table and to name the variable names in the dataset.
...
To include R code inside Markdown text use single back ticks instead of three: 
Number of variables: `r mydata %>% ncol`
Total number of observations: `r mydata %>% nrow()`
